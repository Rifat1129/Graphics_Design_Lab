...
/////// Jodi ami 3 ta different color korte chai taile eita change korte hobe
...
int main()
{
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Rifat Hassan", NULL, NULL);
    if (window == NULL)
    {
...
/////// Jodi ami 3 ta different color korte chai taile eita change korte hobe
    unsigned int fragmentShaderGreen = glCreateShader(GL_FRAGMENT_SHADER);// the second fragment shader that outputs the color yellow
...
/////// Jodi ami 3 ta different color korte chai taile eita change korte hobe
    ...
    unsigned int VBOs[3], VAOs[3];   /////// Jodi ami 3 ta different color korte chai taile eita change korte hobe
...
/////// Jodi ami 3 ta different color korte chai taile eita change korte hobe
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glBindVertexArray(VAOs[0]);
        glDrawArrays(GL_TRIANGLES, 0, 6);	// this call should output an orange triangle
